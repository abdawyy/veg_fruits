@if ($banners->isNotEmpty())
    <section class="border-b border-slate-200 bg-surface dark:border-slate-800 dark:bg-slate-900/60" aria-label="{{ __('aldawy.promo_banners') }}">
        <div class="mx-auto max-w-6xl space-y-8 px-4 py-10">
            @foreach ($banners as $banner)
                ...
                @endphp
                <article
                    class="overflow-hidden rounded-3xl border border-slate-200 shadow-md dark:border-slate-700"
